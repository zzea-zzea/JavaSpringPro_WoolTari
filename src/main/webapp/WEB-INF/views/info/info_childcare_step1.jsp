	...
	$(document).ready(
			function() {
				...
				$(".info_content1").click(function() {
					$('.info_content_childcare1').show();
					$('.info_content_childcare2').hide();
					$('.info_content_childcare3').hide();
					$('.info_content_childcare4').hide();
				...
				$(".info_content2").click(function() {
					$('.info_content_childcare1').hide();
					$('.info_content_childcare2').show();
					$('.info_content_childcare3').hide();
					$('.info_content_childcare4').hide();
	...
	<main class="childcare_main">
		<div class="childcare_box ma">
			...
			<div class="info_content">
				<div class="info_content_childcare1">
				...
				<div class="info_content_childcare2">
					<section class="childcare_section">
						<div class="childcare_section_title">
							<h2>임신 주수 변화</h2>
...
.cls-9 {
	fill: #2c435e;
				...
				<div class="info_content_childcare3">
					<section class="childcare_section">
						<div class="childcare_section_title">
							<h2>신생아 (생후 ~ 4주)</h2>
				...
				<div class="info_content_childcare4">
				<section class="childcare_section">
				<div class="childcare_section_title">
...
.cls-9 {
	fill: #2c435e;
									...
									<path class="cls-9"
										d="M39.67,4.42h3.92a0,0,0,0,1,0,0V8.33a2,2,0,0,1-2,2h0a2,2,0,0,1-2-2V4.42a0,0,0,0,1,0,0Z"
										transform="translate(83.25 14.71) rotate(-180)" /></svg>
								<span>15주에서 18주 사이에 산모 혈액을 이용한 <b>기형아 검사</b>를 시행하여 태아의 개방
									신경관 결손과 염색체의 이상에 대한 <b>선별 검사</b>를 시행하며, 다운 증후군과 같은 염색체 이상의 위험도가
									높은 산모를 선별하여 <b>양수 검사</b>를 시행할 수 있도록 합니다. 임신 20주경에는 태아의 전반적인 구조적
									이상 여부를 초음파를 통해 정밀하게 임신 24~28주 사이에는 <b>임신성 당뇨 검사</b>를 시행합니다.
								</span>
							</div>
						</div>
					</div>
