	...
	<main class="policy_main">
		<div class="policy_box ma">
			...
			<div class="policy_content_search">
				<select class="selectpicker le" data-size="5" id="main-city"
					name="local_si">
			...
			<div class="policy_content_maintxt">
				...
				<span class="su_txt">
					 #성인 한부모가족(조손가족 포함)<br>
					지원 구분 지원조건 지원내용 아동양육비 저소득 한부모가족의 만 18 세 미만 아동 자녀 1 인당 월 20 만원
					「국민기초생활보장법」에 따른 생계급여를 지원받는 한부모가족의 만 18세 미만 자녀 * ’21.5월부터 적용 자녀 1 인당
					월 10 만원 추가 아동양육비 저소득 조손가족 및 만25 세 이상 미혼 한부모가족의 만 5 세 이하 아동 * 만 24 세
					이하 미혼한부모의 경우 청소년한부모로써 월 35 만원의 아동양육비를 지원하므로 제외 * ’21.5월부터 만 35세 이상인
					경우 지급 자녀 1 인당 월 5 만원 추가 아동양육비 만 25세 이상 34세 이하 청년 한부모가족의 만 5세 이하 아동
					* ’21.5월부터 적용 자녀 1 인당 월 10 만원 추가 아동양육비 만 25세 이상 34세 이하 청년 한부모가족의 만
					6세 이상 18세 미만 아동 * ’21.5월부터 적용 자녀 1 인당 월 5 만원 아동교육지원비 저소득 한부모가족의 중학생
					및 고등학생 자녀 자녀 1 인당 연 8.3만원 생계비 (생활보조금) 한부모가족복지시설에 입소한 저소득 한부모가구 가구당
					월 5 만원 * 모든 급여는 소득인정액이 기준 중위소득 52% 이하인 가족을 지원대상으로 함 * 연령 기준이
					연나이(’18년도)에서 만나이(’19년~)로 변경됨을 유의 #청소년 한부모가정 지원 구분 지급시기 지원액 지원대상
					지원계획 청소년 한부모 아동양육비 월별 지급 월 35 만원* 기준 중위소득 60 % 이하 계좌입금 청소년 한부모
					검정고시학습비 수시지급 (신청 시) 연 154 만원 이내 기준 중위소득 60 % 이하 해당 청소년 한부모가 등록한 학원
					또는 개인계좌로 입금 청소년 한부모 고교생교육비 분기별 지급 실비** 기 준 중위소득 52 % 해당 청소년 한부모가 재학
					초과~60 % 중인 학교로 계좌입금 (교육급여 수급자 제외) 청소년 한부모 자립촉진수당 월별 지급 월 10 만원 기준
					중위소득 60%이하 계좌입금 * '21.5월부터 생계급여 지원 한부모가족 대상 월 25만원 아동양육비 지원 가능 **
					특수목적고 및 자율형사립고 등은 연간 최대 5백만원 한도내에서 지원가능 
				</span> 
				<span class="gg_txt hide"> 
					#저소득 한부모가정 건강검진 지원 기간 :
					매년 1회 장소 : 관내 병원 지원대상 : 저소득 한부모가족 세대주 160명 지원금액 : 건강검진비용 1인당 110천원
					지원 지원내용 : 초음파검사, 혈액종합검사 등 검진비 지원 # 미혼모⦁부 초기지원 기간 : 2020년 1월 ~ 계속 장소
					: 모자가족복지시설 지원대상 : 부천시에 거주하는 미혼모⦁부(세대) 지원내용 상담을 통한 미혼모⦁부자의 정서 지원 출산
					및 양육지원 사업 산비 및 아이의 입원, 예방접종비 등 병원비 분유, 유모차, 보행기, 장난감 등 양육용품 지원비
					지원금액 : 연간 가구당 70만원 이하 (자녀가 12개월 이하인 경우 연간 30만원 한도 추가 지원) 친자검사비
					지원(실비) 교육문화체험프로그램 및 자조모임 운영 지원 지역사회 유관기관의 연계지원 미혼모 출산 후 은가림빌 유휴공간을
					활용하여 우선입소 연계 #한부모가족 복지시설 퇴소자 자립지원 한부모가족 복지지설 퇴소자 자립지원금 기 간 : 연중 대 상
					• 새롱이새남이집 입소기간 1년 6월이상된 자로 자립의지가 있으며, 시설 퇴소 후 성남시에 거주예정인 세대로서 •
					입소기간중 직업교육 후 자격증 취득(수료)하거나 또는 취업하여 3월이상 안정된 생활을 한 세대 지원범위 : 퇴소후
					전․월세 보증금, 창업을 위한 임대보증금 지원금액 : 1세대당 5백만원 
				</span> 
				<span class="gw_txt hide">
					 # 지원 내용 한부모가족증명서 발급(기준
					중위소득 60% 이하) 복지급여 지급(기준 중위소득 52% 이하) 지원종류 지원대상 지원금액 아동양육비 •소득인정액이
					기준 중위소득 52% 이하인 가족의 만 18세 미만 자녀 월 20만원 •「국민기초생활보장법」에 따른 생계급여를 지원받는
					한부모가족의 만 18세 미만 자녀 월 10만원 //* ’21.5월부터 적용 자녀 1인당 추가 아동양육비 •소득인정액이
					기준 중위소득 52% 이하인 조손 및 만 35세 이상 미혼 한부모가족의 만 5세 이하 아동 자녀 1인당 월 5만원
					•소득인정액이 기준 중위소득 52% 이하인 만 25세 이상 34세 이하 청년 한부모가족의 만 5세 이하 아동 자녀 1인당
					* ’21.5월부터 적용 월 10만원 •소득인정액이 기준 중위소득 52% 이하인 만 25세 이상 34세 이하 청년
					한부모가족의 만 6세 이상 18세 미만 아동 자녀 1인당 * ’21.5월부터 적용 월 5만원 아동교육 지원비 (학용품비)
					•소득인정액이 기준 중위소득 52% 이하인 가족의 중학생‧고등학생 자녀 자녀 1인당 연 8.3만원 생계비 (생활보조금)
