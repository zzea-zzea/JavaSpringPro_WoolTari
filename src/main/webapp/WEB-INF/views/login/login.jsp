				...
				<div class="login_box_menu">
					<fieldset>
						...
						<div class="login_box_small_menu">
							<span class="menu_join"> 
								<a class="join_link"href="${pageContext.request.contextPath}/signUp.woo">회원가입</a>
							</span> 
							<span class="menu_find"> 
								<a class="find_link" href="${pageContext.request.contextPath}/findid.woo">아이디 / 비밀번호 찾기</a>
							</span>
						</div>
					</fieldset>
				</div>
