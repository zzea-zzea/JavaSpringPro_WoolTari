	...
	<%@ include file="../common/_header.jsp"%>
		<main class="retouch_content_main">
			<div class="write_first_box ma">
				...
				<hr>
				<form method="post" action="${pageContext .request.contextPath}/community_update.woo">
				<div class="new_write_title">
					...
					<input type="text" name="title" class="input_title rewri" value="${community.title}" size="60px"><br>
