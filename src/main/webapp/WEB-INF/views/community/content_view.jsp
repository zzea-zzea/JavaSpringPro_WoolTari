				...
				<div class="community_first_view">
						...
						<div class="col-md-8">
							<div class="row">
								<c:if test="${not empty param['totalMB']}">
									<span class="unit_mb" style="color: blue"> <b> 총 <c:out
												value="${param.countFiles}" default="0" /> 개 파일들용량:
											${param.totalMB}MB
									</b>
									</span>
								</c:if>
					...
					<div class="community_imfo_retouch_delet">
						<input type="button" value="삭제" class="btn_content"
							...
							class="btn_content" onclick="retouch_check()">
					</div>
					<div class="community_comment_box">
						...
						<div class="reply">
							...
							<div class="reply_del_ret">
								...
								&nbsp;<a role="button" class="layer_button"
									onclick="reply_delete_check()">삭제</a> <a role="button"
							...
							<div class="community_reply" id="a">
								<input type="image" src="${path}/resources/img/reply/woman.png"
									...
									placeholder="댓글을 입력해주세요" class="reply_re" size="70px">
...
<script type="text/javascript">
	$(document).ready($('input_new_reply').click(function() {
		$('#a').toggle();
	}));
</script>
<script>
